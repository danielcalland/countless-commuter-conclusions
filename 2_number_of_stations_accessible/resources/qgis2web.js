...
map.getView().fit([-204964.268340, 6607312.721930, 182726.076941, 6837850.016534], map.getSize());
...
function createPopupField(currentFeature, currentFeatureKeys, layer) {
    ...
    function addField(label, value) {
        if (value && value !== '') {
            popupText += '<b>' + label + ':</b> ' + value + '<br>';
        }
    }

    addField('Station Name', currentFeature.get('Station Name'));
    addField('Code', currentFeature.get('Code'));

    addField('Primary Station', currentFeature.get('Primary Station'));
    addField('Primary Operator', currentFeature.get('Primary Operator'));
    addField('Primary Time', currentFeature.get('Primary Time'));

    addField('Secondary Station', currentFeature.get('Secondary Station'));
    addField('Secondary Operator', currentFeature.get('Secondary Operator'));
    addField('Secondary Time', currentFeature.get('Secondary Time'));

    addField('Tertiary Station', currentFeature.get('Tertiary Station'));
    addField('Tertiary Operator', currentFeature.get('Tertiary Operator'));
    addField('Tertiary Time', currentFeature.get('Tertiary Time'));

    addField('Fourth Station', currentFeature.get('Fourth Station'));
    addField('Fourth Operator', currentFeature.get('Fourth Operator'));
    addField('Fourth Time', currentFeature.get('Fourth Time'));

    addField('Fifth Station', currentFeature.get('Fifth Station'));
    addField('Fifth Operator', currentFeature.get('Fifth Operator'));
    addField('Fifth Time', currentFeature.get('Fifth Time'));

    addField('Sixth Station', currentFeature.get('Sixth Station'));
    addField('Sixth Operator', currentFeature.get('Sixth Operator'));
    addField('Sixth Time', currentFeature.get('Sixth Time'));

    addField('Seventh Station', currentFeature.get('Seventh Station'));
    addField('Seventh Operator', currentFeature.get('Seventh Operator'));
    addField('Seventh Time', currentFeature.get('Seventh Time'));

    addField('Eighth Station', currentFeature.get('Eighth Station'));
    addField('Eighth Operator', currentFeature.get('Eighth Operator'));
    addField('Eighth Time', currentFeature.get('Eighth Time'));

    addField('Ninth Station', currentFeature.get('Ninth Station'));
    addField('Ninth Operator', currentFeature.get('Ninth Operator'));
    addField('Ninth Time', currentFeature.get('Ninth Time'));

    addField('Tenth Station', currentFeature.get('Tenth Station'));
    addField('Tenth Operator', currentFeature.get('Tenth Operator'));
    addField('Tenth Time', currentFeature.get('Tenth Time'));

    addField('Total Station Count', currentFeature.get('Total Station Count'));
